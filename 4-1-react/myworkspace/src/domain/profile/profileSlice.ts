...
// // redux store 리덕스 저장소에 하나의 state를 관리하고 처리하는 모듈 
// // silce에는 state 와 reducer가 있음 
// // reducer 는 state 를 변경하는 함수 
...
//   name: "profile",       // slice 의 이름 
//   initialState: {},      // 이 slice 의  state 초기값  
//   reducers: {
